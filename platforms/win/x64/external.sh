...
cp build/${BUILD_TYPE}/dmdutil64.lib ${PROJECT_SOURCE_ROOT}/third-party/build-libs/win/x64/
cp build/${BUILD_TYPE}/dmdutil64.dll ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/win/x64/
cd ..
...
cp SDL/build/${BUILD_TYPE}/SDL364.lib ${PROJECT_SOURCE_ROOT}/third-party/build-libs/win/x64/
cp SDL/build/${BUILD_TYPE}/SDL364.dll ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/win/x64/
