...
rm -rf external
mkdir -p external third-party/include third-party/build-libs/ios-simulator/arm64
cd external
...
cp build/libdmdutil.a ../../third-party/build-libs/ios-simulator/arm64/
cd ..
...
cp SDL/build/libSDL3.a ../third-party/build-libs/ios-simulator/arm64/
