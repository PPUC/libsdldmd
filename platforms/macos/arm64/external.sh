...
cp -a build/libdmdutil.{dylib,*.dylib} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
cd ..
...
cp -a SDL/build/libSDL3.{dylib,*.dylib} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/macos/arm64/
